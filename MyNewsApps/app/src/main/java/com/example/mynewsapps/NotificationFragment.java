...
public class NotificationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View newsView = inflater.inflate(R.layout.fragment_notification, container, false);
        Bundle b = getArguments();
        String username = getBundleString(b, "username", "default");
        if (username != "default"){
            tv_greeting = newsView.findViewById(R.id.tv_greeting_fav_news);
            tv_greeting.setText(username);
        };

        String url = ip+"/login-signup/getFavProduct.php?username="+username;

        //getting the recyclerview from xml
        recyclerView = newsView.findViewById(R.id.recyclerView_for_news_fav_page);
